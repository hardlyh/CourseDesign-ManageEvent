				   ...
				   <div class="row">
						...
						<div class="col-md-12" >
							...
							<p style="font-size: 15px;color:#708090;" >
								...
								<input type="text" name="condition" placeholder="标题" style="width: 150px;height: 30px;margin-left: 10px;">
									...
									<table class="table" >
										...
										<c:forEach items="${pageBean.list }" var="pb" varStatus="status">
											<tr>
												...
												<td>
													<span class="label label-primary tupian" style="cursor: pointer">查看图片</span>
												</td>
