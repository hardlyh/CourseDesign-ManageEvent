						...
						<div class="content">
							...
							<form class="form-auth-small" action="tUserAction_login" method="post">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="user.userName" id="signin-email"   placeholder="账号">
								</div>
								<div class="form-group">
									<label for="signin-password" class="control-label sr-only">Password</label>
									<input type="password" class="form-control" id="signin-password" name="user.userPassword" placeholder="密码">
								</div>
